...
public class LocationProviderHandler extends LocationProvider implements LocationListener {
    ...
    public Location getLocation() {
        ...
        //Added my Rami
        mLogger.postInfo("Debug Info",  Double.toString(mCurrentLocation.getLatitude()));
        mLogger.postInfo("Debug Info",  Double.toString(mCurrentLocation.getLongitude()));
        mLogger.postInfo("Debug Info",   Double.toString(mCurrentLocation.getAltitude()));
