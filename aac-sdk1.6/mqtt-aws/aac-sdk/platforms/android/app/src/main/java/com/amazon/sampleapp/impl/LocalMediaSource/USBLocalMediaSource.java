...
public class USBLocalMediaSource extends LocalMediaSource {
    ...
    public USBLocalMediaSource (Context context, LoggerHandler logger, Source usb ) {
        super(usb, new USBSpeaker());
        mLogger = logger;
    }
    ...
    public boolean authorize( boolean authorized ) {
        ...
        mLogger.postInfo( sTag, String.format( "USB Mock Local Source player %s", authStr) );
    ...
    public LocalMediaSourceState getState() {
        ...
        stateToReturn.playbackState.mediaProvider = "local USB player";
