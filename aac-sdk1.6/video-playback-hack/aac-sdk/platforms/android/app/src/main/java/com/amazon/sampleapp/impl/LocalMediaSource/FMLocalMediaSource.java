...
public class FMLocalMediaSource extends LocalMediaSource {
    ...
    public FMLocalMediaSource (Context context, LoggerHandler logger, Source fm ) {
        super(fm, new FMLocalMediaSource.FMSpeaker());
        mLogger = logger;
    }
    ...
    public boolean authorize( boolean authorized ) {
        ...
        mLogger.postInfo( sTag, String.format( "FM Mock Local Source player %s", authStr) );
    ...
    public LocalMediaSourceState getState() {
        ...
        stateToReturn.playbackState.mediaProvider = "local FM player";
