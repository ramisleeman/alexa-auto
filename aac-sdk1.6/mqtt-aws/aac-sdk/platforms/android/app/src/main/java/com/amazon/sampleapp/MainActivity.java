...
//    private MetricsUploadService mMetricsUploadService;
    ...
    private void startEngine(String json) throws RuntimeException {
        ...
        mLogger.postInfo( sTag, String.format( "Step 1 "));
        mUSBLocalMediaSource =  new USBLocalMediaSource(this, mLogger, USBLocalMediaSource.Source.USB);

        mLogger.postInfo( sTag, String.format( "Step 2 "));
        mCDLocalMediaSource =  new CDLocalMediaSource(this, mLogger, CDLocalMediaSource.Source.COMPACT_DISC );

        mLogger.postInfo( sTag, String.format( "Step 3 "));
        mFMLocalMediaSource =  new FMLocalMediaSource(this, mLogger, FMLocalMediaSource.Source.FM_RADIO );
        FMLocalMediaSource.Source.
        ...
        if ( !mEngine.registerPlatformInterface(mCDLocalMediaSource))
            throw new RuntimeException( "Could not register Mock CD player Local Media Source platform interface" );


        if ( !mEngine.registerPlatformInterface(mFMLocalMediaSource))
            throw new RuntimeException( "Could not register Mock FM player Local Media Source platform interface" );



        //this works and I am able to set the language setting
        //mEngine.setProperty( com.amazon.aace.alexa.AlexaProperties.LOCALE, "de-DE" );
